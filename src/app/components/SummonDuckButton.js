...
export const SummonDuckButton = ({ addDuck }) => {
    ...
    return (
        <button onClick={summonDuck}
            tabIndex={1}
            className='fixed top-[50%] left-[50%] -translate-y-1/2 -translate-x-1/2 border-solid cursor-pointer rounded-[500px] uppercase min-w-[160px] text-2xl text-center p-5 font-bold transition ease-in-out duration-450
